...
// Generated by cmake/ForkVersion.cmake. Defines CHATTERINO_FORK_VERSION and
// CHATTERINO_FORK_RELEASE - this fork numbers its own releases from git tags
// instead of following upstream's version.
#include <ForkVersion.hpp>
#include <QString>
 ...
 *  - 2.4.0-alpha
 **/
inline const QString CHATTERINO_VERSION = QStringLiteral(CHATTERINO_FORK_VERSION);

/// Upstream's version, kept around for the About page.
inline const QString CHATTERINO_UPSTREAM_VERSION = QStringLiteral("2.5.5");
